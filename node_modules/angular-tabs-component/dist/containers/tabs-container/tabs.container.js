...
var TabsContainer = /** @class */ (function () {
    ...
    TabsContainer.decorators = [
        { type: Component, args: [{
                    ...
                    styles: ["\n    *{margin:0px;padding:0px}:host{padding:10px 10px;display:flex;flex-direction:column;position:relative;min-height:calc(100vh - 20px)}.tabs__tab-bar{align-self:center;border-radius:4px;overflow:hidden;margin-bottom:-12px;z-index:1000}.tabs__tab{padding:4px 10px;display:inline-block;background-color:white;cursor:pointer;color:black}.tabs__tab.active{background-color:#9c27b0;box-shadow: 0 14px 26px -12px rgba(156,39,176,.42), 0 4px 23px 0 rgba(0,0,0,.12), 0 8px 10px -5px rgba(156,39,176,.2);color:white}.overlay{background:#e0e0e0;opacity:0.5;bottom:0;left:0;position:absolute;right:0;top:0;z-index:1000}\n  "]
                },] },
    ];
    /** @nocollapse */
